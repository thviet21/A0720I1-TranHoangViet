...
function change(part_id) {
    let get_img = document.getElementById(`${part_id}`);
    switch (part_id) {
        case 'part1':
...
function checkImage() {
    ...
    if (part1.getAttribute("src") === "./img/funny-cat1_part1x1.jpg"
        ...
        alert("Đúng hình mèo rồi");
        document.getElementById("puzzle").style.boxShadow = '0 0 3px 3px green';
        return;
    }
        else if (part1.getAttribute("src") === "./img/monkey_part1x1.jpg"
        ...
        alert("Đúng hình khỉ rồi");
        document.getElementById("puzzle").style.boxShadow = '0 0 3px 3px green';
        return;
    }
    else if(part1.getAttribute("src") === "./img/panda_swap_part1x1.jpg"
