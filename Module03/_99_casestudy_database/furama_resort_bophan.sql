...
CREATE TABLE `bophan` (
  ...
  UNIQUE KEY `idbophan_UNIQUE` (`idbophan`)
...
INSERT INTO `bophan` VALUES (1,'marketing'),(2,'room'),(3,'lễ tân'),(4,'bếp'),(5,'it'),(6,'bảo vệ'),(7,'vệ sinh'),(8,'hành chính'),(9,'Phục vụ'),(10,'Quản lý');
